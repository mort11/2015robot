...
public class TeleopConstants {
	...
	public static final int presetThreeToteButton = 9;
	public static final int presetFourToteButton = 10;
	public static final int presetFiveToteButton = 7;
	public static final int presetSixToteButton = 8;
	public static final int leftJoystickPortNum = 1;
